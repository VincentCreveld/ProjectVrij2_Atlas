...
public class BossController : MonoBehaviour
{
    ...
    [FMODUnity.EventRef]
    public string MusicGameplay = "event:/Music/MusicGameplayNonLineair2";
    ...
    public void Stage1()
    {
        ...
        else
        {
            ...
            //Audio
            //StageParameter.setValue(1.5f);
            //End Audio



        }
        if (CurrentHp() < hp.maxHealth * 1)
        {
            //60%
            //Debug.Log("60% or less");
        ...
        if (CurrentHp() < hp.maxHealth * 0.99f)
        {
            //99%%
            //Debug.Log("99%");
    ...
    public void MoveTowardsPlayer()
    {
        ...
        {
            this.transform.position = Vector2.MoveTowards(new Vector2(this.transform.position.x, 0), new Vector2(player.transform.position.x, 0), 0.025f);
        }
    }
    #region manage stats
